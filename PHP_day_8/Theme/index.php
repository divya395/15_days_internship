...
$q = mysqli_query($connection, "insert into theme (user_name,user_email,user_message) values('{$name}','{$email}','{$message}')")
            ...
            <div class="tm-black-bg tm-mb-20 tm-about-box-1">              
              ...
              <div class="tm-list-item tm-list-item-2">                
                ...
                <div class="tm-list-item-text-2">
                  <p>Wave Cafe is a online page where you can order backery items.You can find Coffee,Latteand much more variety of bavrages.</p>
            ...
            <div class="tm-black-bg tm-mb-20 tm-about-box-2">              
              <div class="tm-list-item tm-list-item-2">                
                <div class="tm-list-item-text-2">
                  ...
                  <p>If you wish to support us Thank you. Duis bibendum erat nec ipsum consectetur sodales.</p>                  
                </div>                
